...
#params = torch.load('./model/mobilenet_PRE_01_30step_lfw.pth')
...
#data_dir = '/home/chenjun/Desktop/Dataset/data'
...
##
#torch.save(model_r18.state_dict(), './test/model/lfwa_no_load_res18.pth')
